...
A modern storage management and file sharing platform that lets users effortlessly upload, organize, and share files. Built with Next.js 15 and the Appwrite Node SDK, utilizing advanced features for seamless file management.
